...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, user, onSignOut, onProfileClick }) => {
  ...
  return (
    <div className="fixed z-50 transition-all duration-300
      ...
      bg-white/90 backdrop-blur-xl border border-white/40 shadow-2xl rounded-[1.5rem]
    ...
    ">
              ...
              <button
                ...
                className={`group relative flex items-center justify-center lg:justify-start p-2.5 lg:px-5 lg:py-4 rounded-xl md:rounded-2xl transition-all duration-200 shrink-0 ${
                  isActive 
                    ...
                    : 'text-slate-500 lg:hover:bg-slate-50 lg:hover:text-emerald-500'
                }`}
                title={item.label}
              >
      ...
      <div className="flex flex-row md:flex-col items-center md:items-stretch gap-1 md:gap-2 md:w-full md:border-t border-l md:border-l-0 border-slate-200 pl-1 md:pl-0 md:pt-6 ml-1 md:ml-0 shrink-0">
        ...
        <button 
          onClick={onSignOut} 
          className="group relative flex items-center justify-center lg:justify-start p-2.5 lg:px-5 lg:py-4 rounded-xl md:rounded-2xl text-slate-400 lg:hover:text-rose-500 lg:hover:bg-rose-50 transition-all duration-200 shrink-0"
        >
